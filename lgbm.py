...
def feature_engineering(street_name: str, prints: bool = False):
	# --- load data ---
...
def make_model(df, street_name, prints: bool = False):
...
if __name__ == '__main__':
	...
	for street in streets:
		make_model(feature_engineering(street), street, prints = True)
